...
public class ITReadGeneralTest {
    ...
    public void ITReadGeneralTwo() throws Exception {
        ...
        Announcement ann = this.postGeneral(pubkey, privkey, stub, "A0", null, "0:0");
        anns.add(ann);
        ann = this.postGeneral(pubkey, privkey, stub, "A1", null, "0:1");
        anns.add(ann);
    ...
    public void ITReadGeneralOneDiffClient() throws Exception {
        ...
        ann = this.postGeneral(pubkey2, privkey2, stub, "B0", null, "1:0");
        anns2.add(ann);
    ...
    public void ITReadGeneralTwoDiffClient() throws Exception {
        ...
        ann = this.postGeneral(pubkey2, privkey2, stub, "B0", null, "1:0");
        anns2.add(ann);
        ann = this.postGeneral(pubkey2, privkey2, stub, "B1", null, "1:1");
        anns2.add(ann);
    ...
    public void ITInvalidNonce() throws Exception {
        ...
        Response responseRead = stub.readGeneral(1, pubkey, clientNonce, (long) 1, Crypto.sign(privkey, messageRead.getByteArray()));
    ...
    public void ITReadGeneralOneWithRef() throws Exception {
        ...
        arr.add(ann);
        Announcement ann2 = this.postGeneral(pubkey, privkey, stub, "A1", arr, "0:1");
        ArrayList<Announcement> anns = new ArrayList<Announcement>();
        anns.add(ann2);
    ...
    public void ITReadGeneralOneWithRefFromDiffClient() throws Exception {
      ...
      ArrayList<Announcement> arr = new ArrayList<Announcement>();
      arr.add(ann);
      Announcement ann2 = this.postGeneral(pubkey2, privkey2, stub, "B0", arr, "1:0");
      ArrayList<Announcement> anns = new ArrayList<Announcement>();
      anns.add(ann2);
    ...
    public void ITReadGeneralOneWithTwoRefsFromGenBoardAndDiffClientAnnBoard() throws Exception {
      ...
      ann = this.postGeneral(pubkey2, privkey2, stub, "B0", null, "1:0");
      arr.add(ann);
      Announcement ann2 = this.postGeneral(pubkey2, privkey2, stub, "B1", arr, "1:1");
      ArrayList<Announcement> anns = new ArrayList<Announcement>();
      anns.add(ann2);
