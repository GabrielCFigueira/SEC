...
/**
 * NClient/NServer Test: read
 *
 * Read1Client4Server
 * Read2Client4Server
 * Read1Client4Server1F
 */
public class ITReadNServerTest {
    ...
    public void init() throws IOException, RemoteException, KeyStoreException, AlreadyBoundException, NoSuchAlgorithmException, UnrecoverableKeyException, CertificateException, NotBoundException, SigningException {
        ...
        client2.post("Boas2".toCharArray(), null);
    }
    ...
    @Test
    public void Read1Client4Server() throws IOException, RemoteException, SigningException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException, CertificateException, Exception {
    ...
    public void Read2Client4Server() throws IOException, RemoteException, SigningException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException, CertificateException, Exception {
		...
		assertEquals("Boas2", new String(read1.get(0).getMessage()));
